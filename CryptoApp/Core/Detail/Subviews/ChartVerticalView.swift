...
private extension ChartVerticalView {
	...
	var chartView: some View {
		Chart {
			...
			ForEach(Array(data.enumerated()), id: \.offset) { index, value in
				...
				LineMark(
					x: .value("Day", date),
					y: .value("Price", minY + (value - minY) * animatePercentage)
				)
...
#Preview {
	ChartVerticalView(coin: MockData.instance.coin)
}
